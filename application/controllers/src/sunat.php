			...
			if($ruc != "" && $numRand!=false)
			{
              ...
              // echo $Page;
				...
				foreach($busca as $i=>$v)
				{
					...
					//$patron='<div class="col-sm-5"><h4 class="list-group-item-heading">*>'.$v.':[ ]*<\/td>\r\n[\t]*[ ]+ <div class="col-sm-7"><p class="list-group-item-text">(.*)<\/p><\/div>/';

				//	$patron='/<h4 class="list-group-item-heading">*'.$v.'::[ ]*/<div class="col-sm-7"><\/div><p class="list-group-item-text">(.*)<\/p>/';
					$patron='/<h4 class="list-group-item-heading"*>'.$v.':[ ]*<\/h4>\r\n[\t]*[ ]+<\/div>
