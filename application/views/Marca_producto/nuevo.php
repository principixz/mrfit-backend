...
<script type="text/javascript">
	function guardar(){
		...
		$.post(base_url+"Marca_producto/guardar",$("#formulario").serialize(),function(data){

			location.href=base_url+"Marca_producto";
	...
	var id=$("#id").val();
	if(id!=""){
        $.post(base_url+"Marca_producto/traer_uno",{"id":id},function(data){
