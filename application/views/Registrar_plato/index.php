<div class="">
	...
	<div class="col-md-12">
	<a href="<?php echo base_url();?>Registrar_plato/nuevo"><button class="btn  btn-success" >Nuevo</button></a>
</div>
</div>
<div class="">
	<div class="col-md-12">
			 ...
			 <tbody id="cuerpo_tabla">
			 	<?php
                  foreach ($data["tabla"] as $key => $value) {
                   ...
                   echo "<td>".$value["producto_stock"]."</td>";
...
<script type="text/javascript">
	function editar_producto(id) {
		location.href=base_url+"Registrar_plato/editar/"+id;
	}
